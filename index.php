...
$ALIBABA_CAT_ID= alibaba_category_id();
$CURRENT_PAGE= current_page();
$addpages= (!empty($CURRENT_PAGE)) ? '&page='.$CURRENT_PAGE : '';
$url= 'https://m.alibaba.com/catalogs/--'.$ALIBABA_CAT_ID.'/1?XPJAX=1&_='.time().'&ctoken=139euk04t2a6k';

$json= IS_SCRAPPING($url, true);
...
<title><?php echo SITE_NAME;?> - Search Price easily from various Shop Online<?php echo $pagetitles;?></title>
<meta property="og:title" content="<?php echo SITE_NAME;?> - Search Price easily from various Shop Online<?php echo $pagetitles;?>" />
<meta property="og:type" content="product" />
<meta property="og:url" content="<?php echo CANONICAL;?>" />
<meta property="og:description" content="<?php echo SITE_NAME.$pagetitles;?> provide search and compare prices easily and quickly from various online stores in the World." />
...
<meta name="description" content="<?php echo SITE_NAME.$pagetitles;?> provide search and compare prices easily and quickly from various online stores in the World." />
<link rel="canonical" href="<?php echo CANONICAL;?>" />
<link rel="prefetch" href="https://i0.wp.com/">
<?php if(!empty($CURRENT_PAGE)){ echo '<meta name="robots" content="NOINDEX,FOLLOW,NOARCHIVE,NOODP,NOYDIR"/>'; }else{ echo '<meta name="robots" content="FOLLOW,NOARCHIVE,NOODP,NOYDIR"/>'; } ?>
<style>
...
<h2 class="mainLnk"><a href="<?php echo HOME_BASE_URL;?>">Best Price All Product</a></h2>
...
$CURRENT_PAGErun= $CURRENT_PAGE+5;	
	for($i=$CURRENT_PAGE+1; $i <=$CURRENT_PAGErun; $i++ ){
	 echo '<li><a href="/catid/'.$ALIBABA_CAT_ID.'?page='.$i.'">'.$i.'</a></li>';
	}
}			
?>
                </ul>
...
echo alibaba_cookies(1, 'index-home', ALIBABA_OFFER);
}
?>
</body>
</html>
